...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[1] || (_cache[1] = createTextVNode(" This is the button ")),
    createVNode(_component_Button, { class: "border-2 border-red-500 p-2 px-10" }, {
...
const VueButton = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
console.log("Hello World");
const app = createApp({});
app.component("FfButton", VueButton);
app.mount("#app");
app.mount(".epi-mouse-focus");
